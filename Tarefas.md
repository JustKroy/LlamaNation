# BRANDELLI
Llama Padrão - Desenho e Animação (Design, Habilidades, Modelo)<br>
Llama ninja - Desenho<br>
Botões e HUD
...
<h3>CARAMUJO GIF (SPRITESHEET)</h3>
NomeDoCaramujoSnailSS.png (Ex: DefaultSnailSS.png) 
